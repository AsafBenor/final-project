...
def generate_nusmv_model_2_cop(rows, columns, board, cop1_holder, cop2_holder, robber_holder):
    model_content = f'''
MODULE main
...
###########
## make sure the cops not getting in the same position in same turn